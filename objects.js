...
function objectGroup(products) {
  ...
  const products = [
    ...
    console.log(objectGroup(products))
...
// ];
function topScoresStudents(students) {
    const topStudents = [];
  ...
  const topStudents = topScoresStudents(students);
...
// car object and adds a new method to the object called age.
